  ...
  //const std::string& dirname)
{
  ...
  //gROOT->ProcessLine(".x $ROOTCOREDIR/scripts/load_packages.C");
     ...
     float xc_ztt = 2100000; //in fb at 
     float lum = 3000; //in fb^-1
     float branch_Htt = 0.06;
     float branch_thh = 0.64;
  ...
  TFile *z = new TFile("/afs/cern.ch/user/g/gpan/public/170727_MMC_Ztautau_2million_UPGRADE_sumet/hist-Ztautau.root");
...
*/
  ...
  TCanvas* c1 = new TCanvas("c1","Ztautau MMC UPGRADE sumet",1500,500);
  c1->Divide(2,1);
...
*/
  ...
  z_truth_MMC->Draw(); z_truth_MMC->GetXaxis()->SetRange(10,200); z_truth_MMC->SetTitle("Z#rightarrow#tau#tau MMC with truth inputs, UPGRADE sumet");
  ...
  z_smear_MMC->Draw("HIST"); z_smear_MMC->GetXaxis()->SetRange(10,200); z_smear_MMC->SetTitle("Z#rightarrow#tau#tau MMC with smeared inputs, UPGRADE, sumet");
